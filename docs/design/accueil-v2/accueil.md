...
| Retard — badge fond / texte | aligné sur le Carnet : `$color-badge-overdue-bg` / `$color-badge-overdue-text` | `#FFE3DF` / `#972622` |
| Retard — bandeau fond / texte | `oklch(96.6% 0.018 27)` / `oklch(44% 0.16 27)` | `#FFF0ED` / `#971B1A` |
...
Le badge « En retard » est aligné sur celui du Carnet (`$color-badge-overdue-bg`
/ `-text`, `#FFE3DF` / `#972622`) et rendu par `shared/DueStatusChip` : décision
de Gaelle du 2026-09-14. Le bandeau « N rappels en retard » garde
`overdue-container` `#FFF0ED` ; son alignement reste une question ouverte.
